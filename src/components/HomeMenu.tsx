...
function HomeMenu() {
    ...
    return (
        <>
            <div className="bg-secondary dark:bg-secondaryNight h-full w-full flex justify-center items-center flex-col gap-4">
                ...
                <div className="w-3/5 h-64 flex gap-4">
                    <div className="bg-primary dark:bg-primaryNight w-2/3 h-full rounded-xl flex flex-col select-none">
                    ...
                    <div className="bg-primary dark:bg-primaryNight w-1/3 h-full rounded-xl flex flex-col select-none">
